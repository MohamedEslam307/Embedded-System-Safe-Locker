...
# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/HAL_GPIO.h" 1
# 14 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/HAL_GPIO.h"
# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../device_config.h" 1
# 14 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/HAL_GPIO.h" 2

# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../mcal_std_types.h" 1
# 13 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../mcal_std_types.h"
# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../std_libraries.h" 1
# 12 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../std_libraries.h"
...
# 12 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../std_libraries.h" 2
...
# 13 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../std_libraries.h" 2
...
# 14 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../std_libraries.h" 2
# 13 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../mcal_std_types.h" 2

# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../compiler.h" 1
# 12 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../compiler.h"
...
# 12 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../compiler.h" 2
# 14 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../mcal_std_types.h" 2
# 37 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/../mcal_std_types.h"
...
# 15 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/HAL_GPIO.h" 2

# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/HAL_GPIO_cnfg.h" 1
# 16 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/HAL_GPIO.h" 2
# 31 "ECU_Layer/ecu_lcd/../../MCAL_Layer/DIO/HAL_GPIO.h"
typedef enum
{
    GPIO_low,
    GPIO_high
...
STD_ReturnType lcd_4bit_initialize (const lcd_4bit_t *lcd)
{
    ...
    else
    {
        ...
        ret = lcd_4bit_send_cmd (lcd,0b00101000);
        ret = lcd_4bit_send_cmd (lcd,0b00000001);
        ret = lcd_4bit_send_cmd (lcd,0b00000011);
        ret = lcd_4bit_send_cmd (lcd,0b00000110);
        ret = lcd_4bit_send_cmd (lcd,0b00001100);
        ret = lcd_4bit_send_cmd (lcd,0b10000000);
                                                    ...
                                                    ,uint8 col,uint8 mem_add)
{
    ...
    {
        uint8 lcd_counter=0;
        ret = lcd_4bit_send_cmd (lcd,(0b01000000 +(mem_add*8)));
...
STD_ReturnType lcd_8bit_initialize (const lcd_8bit_t *lcd)
{
    ...
    else
    {
        ...
        ret = lcd_8bit_send_cmd (lcd,0b00111000);
        ret = lcd_8bit_send_cmd (lcd,0b00000001);
        ret = lcd_8bit_send_cmd (lcd,0b00000011);
        ret = lcd_8bit_send_cmd (lcd,0b00000110);
        ret = lcd_8bit_send_cmd (lcd,0b00001100);
        ret = lcd_8bit_send_cmd (lcd,0b10000000);
    }
    return ret;
}
                                                    ...
                                                    ,uint8 col,uint8 mem_add)
{
    ...
    {
        uint8 lcd_counter=0;
        ret = lcd_8bit_send_cmd (lcd,(0b01000000 +(mem_add*8)));
        for (lcd_counter = 0 ; lcd_counter<8 ; lcd_counter++ )
        {
...
STD_ReturnType lcd_4bit_set_cursor (const lcd_4bit_t *lcd,uint8 row,uint8 col)
{
    ...
    {
        switch (row){
                    case 1: ret = lcd_4bit_send_cmd(lcd,0x80+col); break;
                    case 2: ret = lcd_4bit_send_cmd(lcd,0xC0+col); break;
                    case 3: ret = lcd_4bit_send_cmd(lcd,0x94+col); break;
                    case 4: ret = lcd_4bit_send_cmd(lcd,0xD4+col); break;
...
static STD_ReturnType lcd_8bit_set_cursor (const lcd_8bit_t *lcd,uint8 row,uint8 col)
{
    ...
    {
        switch (row){
                    case 1: ret = lcd_8bit_send_cmd(lcd,0x80+col); break;
                    case 2: ret = lcd_8bit_send_cmd(lcd,0xC0+col); break;
                    case 3: ret = lcd_8bit_send_cmd(lcd,0x94+col); break;
                    case 4: ret = lcd_8bit_send_cmd(lcd,0xD4+col); break;
                    default : ret = (STD_ReturnType)0x00;
        }
    }
    return ret;
