...
# 11 "./ECU_Layer/ecu_initialize.h"
# 1 "./ECU_Layer/ecu_button/ecu_button.h" 1
# 14 "./ECU_Layer/ecu_button/ecu_button.h"
# 1 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/HAL_GPIO.h" 1
# 14 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/HAL_GPIO.h"
# 1 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../device_config.h" 1
# 14 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/HAL_GPIO.h" 2

# 1 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../mcal_std_types.h" 1
# 13 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../mcal_std_types.h"
# 1 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../std_libraries.h" 1
# 12 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../std_libraries.h"
...
# 12 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../std_libraries.h" 2
...
# 13 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../std_libraries.h" 2
...
# 14 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../std_libraries.h" 2
# 13 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../mcal_std_types.h" 2

# 1 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../compiler.h" 1
# 12 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../compiler.h"
...
# 12 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../compiler.h" 2
# 14 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../mcal_std_types.h" 2
# 37 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/../mcal_std_types.h"
...
# 15 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/HAL_GPIO.h" 2

# 1 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/HAL_GPIO_cnfg.h" 1
# 16 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/HAL_GPIO.h" 2
# 31 "./ECU_Layer/ecu_button/../../MCAL_Layer/DIO/HAL_GPIO.h"
typedef enum
{
    GPIO_low,
    GPIO_high
...
# 14 "./ECU_Layer/ecu_button/ecu_button.h" 2
...
# 11 "./ECU_Layer/ecu_initialize.h" 2

# 1 "./ECU_Layer/ecu_led/ecu_led2.h" 1
# 19 "./ECU_Layer/ecu_led/ecu_led2.h"
typedef enum {
    led_on,
    led_off
}led_status_t;
...
# 1 "./ECU_Layer/ecu_dc_motor/ecu_dc_motor.h" 1
...
# 19 "./ECU_Layer/ecu_buzzer/ecu_buzzer.h"
typedef enum {
    buzzer_on,
    buzzer_off
}buzzer_status_t;
...
# 79 "./MCAL_Layer/Interrupt/mcal_external_interrupt.h"
typedef enum {
    High_Priority=0,
    Low_Priority
}Interrupt_Priority;
...
void __attribute__((picinterrupt(("")))) Interrupt_Manger(void);
# 12 "./App.h" 2
...
uint8 Password[10]={0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
...
STD_ReturnType clear_the_entered_password(uint8 *_password){
    ...
    while(temp_password_digits_counter<10){
...
STD_ReturnType set_password(void){
    STD_ReturnType ret = (STD_ReturnType)0x01;
    uint8 Temp_Password_1[10]={0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
    uint8 Temp_Password_2[10]={0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};;
    uint8 compare_status=0;
    ...
    switch (compare_status){
        case 1:
            ...
            if ((STD_ReturnType)0x01==ret){
                ret = clear_password_from_eeprom(10);
                ret = write_the_password_in_eeprom(Temp_Password_2,10);
                ret = Led_turn_on(&green_led);
                ret = lcd_4bit_send_cmd(&lcd,0b00000001);
...
STD_ReturnType password_compare_with_eeprom(uint8 *Password,uint8 *compare_status){
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if ((((void*)0) == Password) ||( ((void*)0) == compare_status)){
...
STD_ReturnType choose_program(uint8 *choossed_program){
    ...
    while(1){
        ...
        if (('1'==pressed_button) || ('2'==pressed_button)){
            break;
        }
    }
...
STD_ReturnType set_passowrd_frist_time (){
    STD_ReturnType ret = (STD_ReturnType)0x01;
    uint8 pressed_key = 0;
    uint8 Temp_Password_1[10]={0};
    uint8 Temp_Password_2[10]={0};
    ...
    while(password_digits_counter <= 10){
        ...
        if (10 == password_digits_counter){
            ...
            if (password_digits_counter>=4){
                ...
                ret = lcd_4bit_send_cmd(&lcd,0b00000001);
                ret = lcd_4bit_send_cmd(&lcd,0b00000011);
                ret = Led_turn_on(&red_led);
                ret = buzzer_turn_on(&buzzer);
